        ...
        <header className="flex items-center justify-between flex-wrap bg-gray-800 p-6">
            ...
            <nav className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                <div className="text-sm lg:flex-grow">
                    <Link className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-gray-400 mr-4" to="/">
                        {t("home")}
                    </Link>
                    <Link className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-gray-400 mr-4" to="/about">
                        {t("about")}
                    </Link>
                    <Link className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-gray-400 mr-4" to="/projects">
                        {t("projects")}
                    </Link>
