        ...
        <div>
            ...
            <div className="m-12 flex flex-wrap justify-around">
                <div className="shadow-md hover:shadow-lg cursor-pointer h-40 w-[500px] p-4">
                    ...
                    <h3 className="text-lg font-medium"><a href="https://blog.ouidou.fr/refactoring-ou-comment-embellir-son-code-fdebff906f93" target={"_blank"} className="text-blue-500" rel="noreferrer">Refactoring, ou comment embellir son code</a></h3>
...
Alexandre Spitz nous présente les bases du refactoring 😀.</p>
                ...
                <div className="shadow-md hover:shadow-lg cursor-pointer h-40 w-[500px] p-4">
                    ...
                    <h3 className="text-lg font-medium"><a href="https://backfooder.fr" target={"_blank"} className="text-blue-500" rel="noreferrer">Backfooder</a></h3>
